...
const Gallery = () => {
    ...
    const trabajos = [
        { src: '/images/exteriorBlanco2.jpg', title: "Pintura de Exterior", category: "Exterior" },
        { src: '/images/interiorNaranja.jpg', title: "Living y Comedor", category: "Interior" },
        { src: '/images/habitacionBlanca.jpg', title: "Habitacion", category: "Habitacion" },
        { src: '/images/paredAzul.jpg', title: "Fachada", category: "Fachada" },
    ];
